  ...
  return (
    <div className="min-h-screen bg-[#fdfdfd]">
      ...
      <ArticleLayout tocItems={tocItems} currentSlug="eat-and-lose">
        ...
        <p className="mb-4">
          問題なのは「食べないこと」ではなく「何を食べるか」。カロリーの質を変え、食べるタイミングを工夫するだけで、<Marker color="blue">1日3食しっかり食べながら月2〜3kgの減量</Marker>を達成できる場合もあります。
        </p>
        <p className="mb-10">
        ...
        <SectionHeading id="is-it-possible">
          ...
          <TipBox title="基礎代謝を下げないための最低カロリー">
            <p>
              一般的に、<Marker color="green">女性は目安として1日1,200kcal程度、男性は1日1,500kcal程度が参考とされていますが、個人差が大きいため医師や栄養士に相談してください</Marker>を下回らないようにしましょう。これを下回ると基礎代謝の低下が始まり、かえって痩せにくくなります。「食べて痩せる」の本質は、この最低ラインを守りながらカロリーの質を上げることです。
            </p>
          </TipBox>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4">
            2003年のJournal of Clinical Endocrinology & Metabolismの研究では、<Marker color="blue">500mlの水を飲むと30分後に一時的に熱産生が亢進することが報告されている</Marker>ことが報告されています。1日2リットルの水を飲む習慣だけで、わずかながら追加消費が期待できますが、個人差が大きいため具体数値を保証することはできません。
          </p>
          <p className="mb-6">
