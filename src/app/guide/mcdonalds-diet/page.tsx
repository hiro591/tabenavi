    ...
    <div className="min-h-screen bg-[#fdfdfd]">
      ...
      <ArticleLayout tocItems={tocItems} currentSlug="mcdonalds-diet">
        ...
        <TipBox title="「セット」の罠に注意">
          <p>バリューセットにすると、ポテトM（409kcal）+ コーラM（140kcal）で<Marker>+549kcal</Marker>。ハンバーガー単品259kcalでも、セットにすると合計808kcalに跳ね上がります。単品注文がダイエットの鉄則です。</p>
        </TipBox>
        ...
        <NumberedList
          items={[
            ...
            },
            {
              ...
              body: "コカ・コーラMサイズは140kcal。爽健美茶やブラックコーヒー（約6kcal）に変えるだけで大幅にカロリーダウンできます。「飲み物で太る」のは最もムダなカロリー摂取です。",
            },
            {
              title: "チキン系バーガーを活用",
        ...
        <FAQSection
          ...
          items={[
            ...
            {
              q: "マックのドリンクで一番太らないのは？",
              a: "ブラックコーヒー（約6kcal）と爽健美茶（0kcal）がほぼゼロカロリーで最もおすすめです。コカ・コーラMサイズ（140kcal）の代わりにこれらを選ぶだけで、1食あたり約140kcalのカットになります。シェイクやマックフィズなどの甘いドリンクは300kcal前後あるため要注意。",
            },
            {
