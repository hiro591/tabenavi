  ...
  return (
    <div className="min-h-screen bg-[#fdfdfd]">
      ...
      <ArticleLayout tocItems={tocItems} currentSlug="mcdonalds-diet">
        ...
        <p className="mb-8">
          この記事では、マクドナルドの全メニューをカロリー低い順にランキングし、ダイエット中のおすすめメニューやPFCバランスを考えた食べ方を、<Marker color="blue">2026年6月時点の公式栄養データ</Marker>に基づいて詳しく解説します。
        </p>
        ...
        <TipBox title="カロリーランキングの見方">
          <p>上位3メニュー（ハンバーガー・チーズバーガー・エッグマックマフィン）は<Marker>いずれも310kcal以下</Marker>。この3つを覚えておけば、迷ったときに安心して注文できます。特にエッグマックマフィンはタンパク質18.6gと栄養バランスにも優れています。</p>
        </TipBox>
        ...
        <WarningBox title="ダイエット中は避けたいメニュー">
          <ul className="space-y-2">
            ...
            <li><span className="font-bold">マックフライポテト®（L）（515kcal）</span> ─ タンパク質わずか7.0gなのに脂質25.0g。栄養バランスが非常に悪い。</li>
            ...
            <li><span className="font-bold">マックフルーリー® オレオ® クッキー（233kcal）</span> ─ カロリーは控えめに見えるが、糖質が大半。デザートは極力控えましょう。</li>
          </ul>
        </WarningBox>
        ...
        <NumberedList
          items={[
            ...
            {
              title: "朝マックは意外と低カロリー",
              body: "エッグマックマフィン（310kcal）はタンパク質18.6gと栄養バランスが良好で、朝マックの中でも特におすすめ。ベーコンエッグマックサンド（294kcal）も低カロリーかつ高タンパクです。朝食をマクドナルドで済ませるのも賢い選択ですが、ソーセージエッグマフィン（477kcal）は脂質30.6gと高めなので注意しましょう。",
            },
          ]}
        />
        ...
        <ComparisonTable
          ...
          rows={[
            ["ダイエット向け", "ハンバーガー + サイドサラダ + 爽健美茶", "269 kcal", "P 13.5g"],
            ["高タンパク", "ダブチ + サイドサラダ + ブラックコーヒー", "475 kcal", "P 27.2g"],
            ["朝マック", "エッグマックマフィン + ブラックコーヒー", "316 kcal", "P 18.9g"],
          ]}
          bestRowIndex={0}
        />
        ...
        <SubSectionHeading>Pattern 2：高タンパクセット（475kcal）</SubSectionHeading>
        <p className="mb-6">
          ダブルチーズバーガー + サイドサラダ + ブラックコーヒー。筋トレ後のタンパク質補給に最適で、<Marker color="blue">P27.2gでしっかりタンパク質を摂取</Marker>できます。475kcalなので、1日のカロリー管理もしやすい範囲です。
        </p>

        <SubSectionHeading>Pattern 3：朝マックおすすめ（316kcal）</SubSectionHeading>
        <p className="mb-8">
          エッグマックマフィン + ブラックコーヒーのシンプルな組み合わせ。朝マックで最も栄養バランスが良く、<Marker color="green">316kcalで高タンパク18.6g</Marker>。忙しい朝でも手軽に栄養を摂れるのが嬉しいポイントです。
        </p>
        ...
        <FAQSection
          ...
          items={[
            ...
            },
            {
              ...
              a: "ハンバーガー単品 + サイドサラダ + 爽健美茶の組み合わせで合計269kcalに抑えられます。タンパク質を多く摂りたい場合はダブルチーズバーガー + サイドサラダ + ブラックコーヒーで475kcal・P27.2gが理想的です。",
            },
            {
              q: "ビッグマックのカロリーとPFCを教えてください",
              a: "ビッグマック®のカロリーは525kcal、タンパク質26.1g、脂質28.0g、炭水化物42.1gです（2026年6月時点のマクドナルド公式栄養情報）。脂質が高めなので、ダイエット中は週1〜2回までに留めるのがおすすめです。",
            },
            {
              q: "朝マックはダイエット中に食べていいですか？",
              a: "朝マックはむしろ積極的に活用すべきです。エッグマックマフィン（310kcal、P18.6g）は通常メニューよりPFCバランスが良く、ダイエット中の朝食として優秀。ベーコンエッグマックサンド（294kcal、P16.3g）はさらに低カロリーで高タンパクです。一方、ソーセージエッグマフィン（477kcal、F30.6g）は脂質が高めなので食べ過ぎに注意しましょう。",
            },
            {
        ...
        <UpdateHistory
          entries={[
            { date: "2026-06-22", note: "栄養データをDB実値で再検証。ソーセージエッグマフィン（477kcal）・ベーコンエッグマックサンド（294kcal）・倍ハンバーガー炭水化物・ポテト(L)/マックフルーリーのカロリー、エッグマックマフィンのタンパク質、組み合わせPattern2の表記を実値へ修正" },
