        ...
        <FAQSection
          ...
          items={[
            ...
            },
            {
              ...
              a: "実は牛丼チェーンの主力メニューは脂質が高めです（牛丼並盛で脂質23g前後、ライザップ牛サラダも398kcal/F24.5g）。ローファット重視ならサイズを小さくする（吉野家ミニ牛丼 352kcal/F14g）か、焼魚系の定食を選ぶのが現実的。ライザップ牛サラダは脂質制限より糖質制限（糖質17.2g）向きのメニューです。",
            },
            {
              q: "コンビニのローファット向き商品は？",
