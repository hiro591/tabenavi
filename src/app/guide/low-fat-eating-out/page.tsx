    ...
    <div className="min-h-screen bg-[#fdfdfd]">
      ...
      <ArticleLayout tocItems={tocItems} currentSlug="low-fat-eating-out">
        ...
        <QuickAnswer
          ...
          answer={
            <>
              <strong>「揚げ物 NG・蒸し/焼き OK」が基本ルール</strong>。脂質15g以下のメニューを優先し、1食あたり脂質を10〜15gに抑えるのが理想です。チェーン別おすすめは<strong>マック「ハンバーガー」（脂質9.5g）/ 吉野家「ミニ牛丼」（脂質14g）/ 松屋「炙り焼鮭朝定食」（脂質9.6g）/ サブウェイ「ローストビーフ」（脂質9.5g）</strong>。揚げ物（チキンフィレオ、唐揚げ系）、クリーム系パスタ、マヨネーズ多用メニューは避けましょう。
            </>
          }
        />
        ...
        <FAQSection
          ...
          items={[
            ...
            },
            {
              ...
              a: "実は牛丼チェーンの主力メニューは脂質が高めです（吉野家の牛丼並盛で633kcal/F23.6g）。ローファット重視ならサイズを小さくする（吉野家ミニ牛丼 352kcal/F14g）か、焼魚系の定食を選ぶのが現実的です。サラダ（吉野家 生野菜サラダ 88kcal/F4.8g）を足して満足感を補うのもおすすめです。",
            },
            {
              q: "コンビニのローファット向き商品は？",
            ...
            },
            {
              ...
              a: "脂質とタンパク質が明記されたメニューを選ぶなら、デニーズの「ハーブ鶏のローストチキンのパワーサラダ」（257kcal/F12.8g/P16.5g）のようなグリルチキン系サラダがおすすめです。ガストの「蒸し鶏と彩り野菜のサラダ」など蒸し鶏系の一品も低脂質になりやすい一方、サイゼリヤやガストは公式に栄養成分の一部（PFC）を非公開のため、脂質は実数値で確認できない点に注意。逆にカルボナーラ・グラタン・ハンバーグ系は脂質30g超のものが多いので避けましょう。",
            },
            {
              q: "サラダドレッシングで太らないものは？",
