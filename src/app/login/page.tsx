    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">外食をもっと賢く、楽しく。</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 border border-gray-200 rounded-2xl text-gray-700 font-medium hover:bg-gray-50 transition flex items-center justify-center gap-2"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          アカウントをお持ちでない方は
          <Link href="/signup" className="text-orange-500 hover:text-orange-600 font-medium ml-1">
            登録
          </Link>
        </p>
      </div>
