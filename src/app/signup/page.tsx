      ...
      <div className="w-full max-w-4xl flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7 sm:p-8 w-full max-w-md animate-fade-in-up delay-200" style={{ animationFillMode: 'both' }}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 bg-black text-white font-medium rounded-xl hover:bg-gray-900 transition-colors flex items-center justify-center gap-2.5 mb-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2.5 mb-5 disabled:opacity-50 disabled:cursor-not-allowed"
          >
