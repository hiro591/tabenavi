    ...
    <div className="min-h-screen bg-white pb-28">
      ...
      <div className="max-w-lg mx-auto px-4">
        ...
        <div className="pt-8 pb-6 text-center">
          <div className="inline-flex items-center justify-center w-32 h-32 bg-orange-50 rounded-3xl mb-4">
            <span className="text-8xl leading-none">{chainEmoji}</span>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-gray-100 py-3 px-4">
        <div className="max-w-lg mx-auto flex gap-3">
          <button className="flex items-center justify-center gap-1 px-4 py-3 border border-gray-200 rounded-xl text-gray-500 hover:bg-gray-50 transition-colors">
            <svg
              className="w-5 h-5"
              fill="none"
              viewBox="0 0 24 24"
