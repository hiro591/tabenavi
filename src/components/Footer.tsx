        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition-colors" aria-label="X (Twitter)">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-orange-400 transition-colors">プライバシーポリシー</a></li>
              <li><a href="#" className="hover:text-orange-400 transition-colors">利用規約</a></li>
              <li><a href="#" className="hover:text-orange-400 transition-colors">お問い合わせ</a></li>
              <li><a href="#" className="hover:text-orange-400 transition-colors">プレスキット</a></li>
              <li><a href="#" className="hover:text-orange-400 transition-colors">パートナー申請</a></li>
            </ul>
          </div>
        </div>
