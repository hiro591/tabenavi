...
export const RELATED_ARTICLES: RelatedArticle[] = [
  ...
  { slug: "joyfull-diet", title: "ジョイフルのダイエット・カロリーガイド｜ファミレスで太りにくいメニューの選び方", description: "ファミレス・ジョイフルでダイエット中でも楽しむための、カロリー・タンパク質・PFCの実データ解説。ハンバーグやサラダ、定食の選び方、高タンパク・低カロリーのおすすめを紹介します。", category: "chain" },
  { slug: "matsunoya-diet", title: "松のやのダイエット・カロリーガイド｜とんかつを太りにくく食べる選び方", description: "とんかつ専門・松のやでダイエット中でも楽しむコツを、カロリー・タンパク質・PFCの実データで解説。ロースとヒレの違い、ご飯・揚げ物量の調整、高タンパクな選び方を紹介します。", category: "chain" },
  { slug: "zetteria-diet", title: "ゼッテリアのダイエット・カロリーガイド｜太りにくいバーガーの選び方", description: "ゼッテリア（ロッテリアの新業態）でダイエット中でも楽しむための、カロリー・タンパク質・PFCの実データ解説。バーガーのカロリー比較、サイドの選び方、低カロリー・高タンパクのおすすめを紹介します。", category: "chain" },
  ...
  { slug: "kurasushi-diet", title: "くら寿司のカロリーガイド｜低カロリーなネタの選び方と太りにくい食べ方", description: "くら寿司のメニューをカロリーの実データで解説。低カロリーなネタ・高カロリーに注意したいネタ、回転寿司で太りにくい食べ方のコツを、ダイエットの視点で紹介します。", category: "chain" },
  { slug: "sushiro-diet", title: "スシローのカロリーガイド｜低カロリーなネタの選び方と太りにくい食べ方", description: "スシローのメニューをカロリーの実データで解説。低カロリーなネタ・高カロリーに注意したいネタ、回転寿司で太りにくい食べ方のコツを、ダイエットの視点で紹介します。", category: "chain" },
